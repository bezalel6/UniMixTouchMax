...
public:
    ...
    static JsonParseResult parseJsonString(const string& jsonString) {
        ...
        DynamicJsonDocument doc(4096);  // Reasonable size limit
    ...
    static MessageProtocol::ExternalMessageType extractMessageType(const MessageVariantMap& variantMap) {
        ...
        if (messageTypeStr == STRING_FROM_LITERAL("STATUS_RESPONSE")) {
            return MessageProtocol::ExternalMessageType::STATUS_RESPONSE;
        } else if (messageTypeStr == STRING_FROM_LITERAL("ASSET_RESPONSE")) {
            return MessageProtocol::ExternalMessageType::ASSET_RESPONSE;
        } else if (messageTypeStr == STRING_FROM_LITERAL("STATUS_REQUEST")) {
            return MessageProtocol::ExternalMessageType::STATUS_REQUEST;
        } else if (messageTypeStr == STRING_FROM_LITERAL("ASSET_REQUEST")) {
            return MessageProtocol::ExternalMessageType::ASSET_REQUEST;
        }
